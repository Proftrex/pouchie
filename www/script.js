...
function deleteTransaction(id, type){
  ...
  /*
   * CALL THE CORRECT SERVER FUNCTION
   */

  if(type === "Savings"){

    runner.deleteSavings(id);

  }
  else{

    runner.deleteTransaction(
      id,
      type
    );
